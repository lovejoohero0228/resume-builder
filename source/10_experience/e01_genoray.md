...
projects: [p01, p02, p05, p13, p14, p06, p07, p11, p12]
---

<!-- lang:ko -->
## 조직/역할 컨텍스트
치과·의료영상 기기 제조사(C-arm 수술용, 치과 영상 시스템)의 AI 시스템 개발.
문제 정의·기획부터 모델 개발·평가·규제 대응·이해관계자 커뮤니케이션까지 프로젝트를
end-to-end로 소유.
<!-- /lang -->

<!-- lang:en -->
## Context
Develops AI systems for a dental / medical-imaging device manufacturer (C-arm surgical,
dental imaging). Owns projects end to end — from problem framing and planning through
model development, evaluation, regulatory documentation, and stakeholder communication.
<!-- /lang -->
